...
class Evaluator:
    def __init__(self, args, out_dir,batch_size,*kwargs):
        input_test_ids, input_test_mask, input_test_tokentype,y_test=kwargs
    ...
    def evaluate(self, model, epoch, print_info=False):
        ...
        self.test_pred = model.predict([self.input_test_ids,self.input_test_mask,self.input_test_tokentype], batch_size=self.batch_size)
