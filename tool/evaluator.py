...
class Evaluator:
    def __init__(self, args, out_dir,batch_size,*kwargs):
        input_test_ids, input_test_mask, input_test_tokentype, X_test, y_test=kwargs
        self.model_type = args.model_type
        self.out_dir = out_dir

        #第一组输入
        self.input_test_ids=input_test_ids
        self.input_test_mask=input_test_mask
        self.input_test_tokentype=input_test_tokentype
        #第二组输入
        self.test_x=X_test
        #标签
        self.test_y=y_test
    ...
    def evaluate(self, model, epoch, print_info=False):
        ...
        self.test_pred = model.predict([ self.input_test_ids,self.input_test_mask,self.input_test_tokentype,
        ...
        #要宏观f1
        self.f1_all = f1_score(self.test_y_label, self.test_pred_label, average='weighted')
        ...
        if print_info:
            logger.info("Evaluation on test data: acc = %0.3f f1 = %0.3f%%" % (self.acc, self.f1_all) )
